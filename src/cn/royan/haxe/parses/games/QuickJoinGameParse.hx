package cn.royan.haxe.parses.games;
...
class QuickJoinGameParse extends SimpleParse<{message:Message,socket:Socket}>{
	public function new()
	{
	...
	{
		return info.message.getCode() == QuickJoinGameRequest.CODE;
	}
}