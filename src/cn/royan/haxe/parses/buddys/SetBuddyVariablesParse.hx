package cn.royan.haxe.parses.buddys;
...
class SetBuddyVariablesParse extends SimpleParse<{message:Message,socket:Socket}>{
	public function new()
	{
	...
	{
		return info.message.getCode() == SetBuddyVariablesRequest.CODE;
	}
}