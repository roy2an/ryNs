...
class InvitationReplayResponse extends Message, implements IBuilder<InvitationReplayResponse>{
	...
	public function build(o:Dynamic):IBuilder<InvitationReplayResponse>
	{
		var i:Int = 0;
	...
	public function getResult():InvitationReplayResponse
	{
		return this;
	}
	...
	{
		return "[InvitationReplayResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}