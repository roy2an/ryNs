...
class SetUserVariablesResponse extends Message, implements IBuilder<SetUserVariablesResponse>{
	...
	public function build(o:Dynamic):IBuilder<SetUserVariablesResponse>
	{
		var i:Int = 0;
	...
	public function getResult():SetUserVariablesResponse
	{
		return this;
	}
	...
	{
		return "[SetUserVariablesResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}