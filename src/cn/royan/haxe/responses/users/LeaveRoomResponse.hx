...
class LeaveRoomResponse extends Message, implements IBuilder<LeaveRoomResponse>{
	...
	public function build(o:Dynamic):IBuilder<LeaveRoomResponse>
	{
		var i:Int = 0;
	...
	public function getResult():LeaveRoomResponse
	{
		return this;
	}
	...
	{
		return "[LeaveRoomResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}