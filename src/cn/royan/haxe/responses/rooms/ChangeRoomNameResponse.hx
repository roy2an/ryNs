...
class ChangeRoomNameResponse extends Message, implements IBuilder<ChangeRoomNameResponse>{
	...
	public function build(o:Dynamic):IBuilder<ChangeRoomNameResponse>
	{
		var i:Int = 0;
	...
	public function getResult():ChangeRoomNameResponse
	{
		return this;
	}
	...
	{
		return "[ChangeRoomNameResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}