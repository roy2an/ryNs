...
class AddBuddyResponse extends Message, implements IBuilder<AddBuddyResponse>{
	...
	public function build(o:Dynamic):IBuilder<AddBuddyResponse>
	{
		var i:Int = 0;
	...
	public function getResult():AddBuddyResponse
	{
		return this;
	}
	...
	{
		return "[AddBuddyResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}