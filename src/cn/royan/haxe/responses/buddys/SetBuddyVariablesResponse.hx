...
class SetBuddyVariablesResponse extends Message, implements IBuilder<SetBuddyVariablesResponse>{
	...
	public function build(o:Dynamic):IBuilder<SetBuddyVariablesResponse>
	{
		var i:Int = 0;
	...
	public function getResult():SetBuddyVariablesResponse
	{
		return this;
	}
	...
	{
		return "[SetBuddyVariablesResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}