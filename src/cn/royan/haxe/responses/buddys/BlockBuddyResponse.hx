...
class BlockBuddyResponse extends Message, implements IBuilder<BlockBuddyResponse>{
	...
	public function build(o:Dynamic):IBuilder<BlockBuddyResponse>
	{
		var i:Int = 0;
	...
	public function getResult():BlockBuddyResponse
	{
		return this;
	}
	...
	{
		return "[BlockBuddyResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}