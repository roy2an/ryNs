...
class CreateGameResponse extends Message, implements IBuilder<CreateGameResponse>{
	...
	public function build(o:Dynamic):IBuilder<CreateGameResponse>
	{
		var i:Int = 0;
	...
	public function getResult():CreateGameResponse
	{
		return this;
	}
	...
	{
		return "[CreateGameResponse=>{orderType:"+orderType+", orderData:"+orderData+"}]";
	}
}